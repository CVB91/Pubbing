...
import {
  UpdatedHouseMutation,
  UpdatedHouseMutationVariables,
} from "src/generated/UpdatedHouseMutation";
...
const UPDATE_HOUSE_MUTATION = gql`
  mutation UpdatedHouseMutation($id: String!, $input: HouseInput!) {
...
export default function HouseForm({ house }: IProps) {
  ...
  const handleCreate = async (data: IFormData) => {
    ...
    if (signatureData) {
      ...
      // Create else statement here and prepare errors
    }
  };
